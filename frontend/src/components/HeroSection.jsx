...
const HeroSection = () => {
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      {/* Hero Card */}
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 md:px-6 py-20">
        <div className="rounded-3xl p-4 md:p-10 w-full animate-fadeInUp" style={{
          backgroundColor: 'rgba(255, 255, 255, 0.80)',
          maxHeight: '70vh',
          maxWidth: '95vw',
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)'
        }} className="md:max-w-4xl md:w-auto">
        {/* Decorative Wave SVG */}
        ...
        <div className="text-center mb-8">
          ...
          {/* Mobile Version */}
          <p className="text-lg mb-2 md:hidden flex flex-col items-center justify-center" style={{
            fontFamily: 'Libre Caslon Text, serif',
            color: '#525A71'
          }}>
            <span className="mb-2">Your AI Stylist on WhatsApp</span>
