      ...
      <nav className="fixed top-4 left-1/2 z-50 px-4 hidden md:block" style={{ transform: 'translateX(-50%)' }}>
        <div className="bg-white/95 backdrop-blur-lg rounded-full px-4 py-2 shadow-lg border border-white/20 animate-slideFromTop" style={{
          ...
          <div className="flex items-center justify-evenly w-full gap-2">
            ...
            {/* CTA Button */}
            <Button className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-medium px-4 py-1.5 rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-sm hover:shadow-xl whitespace-nowrap" style={{
              fontFamily: 'Libre Caslon Text, serif'
            }}>
              Open WhatsApp
            </Button>
